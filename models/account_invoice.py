...
class AccountInvoiceLine(models.Model):
    ...
    def write(self, vals):
        ...
        for line in self.filtered(lambda line: line.invoice_id.type == 'out_invoice'):
            ...
            if line.product_id.membership and not member_lines:
                ...
                date_to = date_from + relativedelta(days=+line.product_id.membership_duration)
    ...
    def create(self, vals):
        ...
        if invoice_line.invoice_id.type == 'out_invoice' and \
            ...
            date_from = fields.Date.today()
            date_to = date_from + relativedelta(days=+invoice_line.product_id.membership_duration)
            if (date_from and
                    date_from <
